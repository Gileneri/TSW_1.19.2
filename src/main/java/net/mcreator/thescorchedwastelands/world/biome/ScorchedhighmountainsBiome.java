...
public class ScorchedhighmountainsBiome {
	public static Biome createBiome() {
		BiomeSpecialEffects effects = new BiomeSpecialEffects.Builder().fogColor(-3591664).waterColor(-13820928).waterFogColor(-13818862).skyColor(-3591664).foliageColorOverride(-6730970).grassColorOverride(-6730970)
				.ambientLoopSound(new SoundEvent(new ResourceLocation("the_scorched_wastelands:blizzard"))).ambientMoodSound(new AmbientMoodSettings(new SoundEvent(new ResourceLocation("the_scorched_wastelands:rarevoices")), 6000, 8, 2))
				...
				.backgroundMusic(new Music(new SoundEvent(new ResourceLocation("the_scorched_wastelands:aridloop")), 12000, 24000, true)).build();
