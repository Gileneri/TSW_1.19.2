...
public class ScorchedlowplainsBiome {
	public static Biome createBiome() {
		BiomeSpecialEffects effects = new BiomeSpecialEffects.Builder().fogColor(-3591664).waterColor(-13820928).waterFogColor(-13818862).skyColor(-3591664).foliageColorOverride(-6730970).grassColorOverride(-6730970)
				.ambientLoopSound(new SoundEvent(new ResourceLocation("the_scorched_wastelands:blizzard"))).ambientMoodSound(new AmbientMoodSettings(new SoundEvent(new ResourceLocation("the_scorched_wastelands:voices")), 6000, 8, 2))
