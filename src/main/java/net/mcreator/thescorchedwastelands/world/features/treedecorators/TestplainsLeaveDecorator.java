...
public class TestplainsLeaveDecorator extends LeaveVineDecorator {
	public static final TestplainsLeaveDecorator INSTANCE = new TestplainsLeaveDecorator();
	public static com.mojang.serialization.Codec<LeaveVineDecorator> codec;
	public static TreeDecoratorType<?> tdt;
	static {
		codec = com.mojang.serialization.Codec.unit(() -> INSTANCE);
		tdt = new TreeDecoratorType<>(codec);
		ForgeRegistries.TREE_DECORATOR_TYPES.register("testplains_tree_leave_decorator", tdt);
	}

	public TestplainsLeaveDecorator() {
		super(0.25f);
	}
