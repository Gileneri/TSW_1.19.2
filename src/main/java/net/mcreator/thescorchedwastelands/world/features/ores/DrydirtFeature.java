...
public class DrydirtFeature extends OreFeature {
	public static DrydirtFeature FEATURE = null;
	public static Holder<ConfiguredFeature<OreConfiguration, ?>> CONFIGURED_FEATURE = null;
	public static Holder<PlacedFeature> PLACED_FEATURE = null;

	public static Feature<?> feature() {
		FEATURE = new DrydirtFeature();
		CONFIGURED_FEATURE = FeatureUtils.register("the_scorched_wastelands:drydirt", FEATURE,
