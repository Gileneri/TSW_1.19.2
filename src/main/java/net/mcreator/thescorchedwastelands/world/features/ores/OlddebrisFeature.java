...
public class OlddebrisFeature extends OreFeature {
	public static OlddebrisFeature FEATURE = null;
	public static Holder<ConfiguredFeature<OreConfiguration, ?>> CONFIGURED_FEATURE = null;
	public static Holder<PlacedFeature> PLACED_FEATURE = null;

	public static Feature<?> feature() {
		FEATURE = new OlddebrisFeature();
		CONFIGURED_FEATURE = FeatureUtils.register("the_scorched_wastelands:olddebris", FEATURE,
				new OreConfiguration(List.of(OreConfiguration.target(new BlockStateMatchTest(TheScorchedWastelandsModBlocks.RED_DRY_SAND.get().defaultBlockState()), TheScorchedWastelandsModBlocks.OLDDEBRIS.get().defaultBlockState()),
						OreConfiguration.target(new BlockStateMatchTest(TheScorchedWastelandsModBlocks.DRYROCK.get().defaultBlockState()), TheScorchedWastelandsModBlocks.OLDDEBRIS.get().defaultBlockState()),
