...
public class Skyscraper110Feature extends Feature<NoneFeatureConfiguration> {
	public static Skyscraper110Feature FEATURE = null;
	public static Holder<ConfiguredFeature<NoneFeatureConfiguration, ?>> CONFIGURED_FEATURE = null;
	public static Holder<PlacedFeature> PLACED_FEATURE = null;

	public static Feature<?> feature() {
		FEATURE = new Skyscraper110Feature();
		CONFIGURED_FEATURE = FeatureUtils.register("the_scorched_wastelands:skyscraper_110", FEATURE, FeatureConfiguration.NONE);
		PLACED_FEATURE = PlacementUtils.register("the_scorched_wastelands:skyscraper_110", CONFIGURED_FEATURE, List.of());
		return FEATURE;
	}
	...
	public boolean place(FeaturePlaceContext<NoneFeatureConfiguration> context) {
		if (!generate_dimensions.contains(context.level().getLevel().dimension()))
			return false;
		if (template == null)
			template = context.level().getLevel().getStructureManager().getOrCreate(new ResourceLocation("the_scorched_wastelands", "skyscraper1_1.0"));
		if (template == null)
			return false;
