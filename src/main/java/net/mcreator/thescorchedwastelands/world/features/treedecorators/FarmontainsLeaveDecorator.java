...
public class FarmontainsLeaveDecorator extends LeaveVineDecorator {
	public static final FarmontainsLeaveDecorator INSTANCE = new FarmontainsLeaveDecorator();
	public static com.mojang.serialization.Codec<LeaveVineDecorator> codec;
	public static TreeDecoratorType<?> tdt;
	static {
		codec = com.mojang.serialization.Codec.unit(() -> INSTANCE);
		tdt = new TreeDecoratorType<>(codec);
		ForgeRegistries.TREE_DECORATOR_TYPES.register("farmontains_tree_leave_decorator", tdt);
	}

	public FarmontainsLeaveDecorator() {
		super(0.25f);
	}
