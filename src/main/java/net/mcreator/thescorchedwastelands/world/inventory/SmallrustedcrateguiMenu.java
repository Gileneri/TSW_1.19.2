...
package net.mcreator.thescorchedwastelands.world.inventory;
...
public class SmallrustedcrateguiMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public SmallrustedcrateguiMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(TheScorchedWastelandsModMenus.SMALLRUSTEDCRATEGUI.get(), id);
